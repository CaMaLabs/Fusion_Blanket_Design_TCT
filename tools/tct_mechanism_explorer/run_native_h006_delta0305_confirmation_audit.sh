...
python3 -u tools/tct_mechanism_explorer/native_h006_delta0305_confirmation_audit.py
RC=$?

OUT="validation_runs/m3dc1_tct_native_h006_delta0305_confirmation"
SUMMARY="$OUT/preemptive_timing_amplitude_refinement_summary.json"

if [[ -f "$SUMMARY" ]]; then
  echo "===== NATIVE h=0.06 DELTA=0.305 CONFIRMATION ====="
