...
| Morphology classifier | causal pre-trigger classifier completed on later unused shots; it underperformed baseline (`33/59`, `43` false triggers vs baseline `35/59`, `30` false triggers), so the simple morphology-classifier path is negative |
...
- Simple causal morphology classifier did not improve the fresh-shot baseline.
...
- [Morphology classifier trigger](validation_runs/fair_mast_morphology_classifier_trigger_default/fair_mast_morphology_classifier_trigger_report.md)
