...
| TCT control response | Predictive trigger supported across reduced BOUT++ current-sheet and independent HW2D-style delayed-growth cases | `predictive_tct_validation.py`, `hw2d_delayed_growth_validation.py`, `validation_runs/predictive_tct_validation_default/`, `validation_runs/hw2d_delayed_growth_validation_default/` | Map the predictive controller onto machine-equilibrium cases and replace synthetic delayed drive with experimentally anchored precursor timing. |
